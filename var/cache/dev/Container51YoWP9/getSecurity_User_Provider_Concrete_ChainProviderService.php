...
return $this->privates['security.user.provider.concrete.chain_provider'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider(($this->services['doctrine'] ?? $this->getDoctrineService()), 'App\\Entity\\Users', 'username', NULL);
