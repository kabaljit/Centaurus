...
// Returns the private 'App\Repository\WorklogRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/WorklogRepository.php';

return $this->privates['App\\Repository\\WorklogRepository'] = new \App\Repository\WorklogRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
