...
// Returns the private 'App\Repository\TimesheetRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/TimesheetRepository.php';

return $this->privates['App\\Repository\\TimesheetRepository'] = new \App\Repository\TimesheetRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
